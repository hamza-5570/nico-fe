        ...
        <div className="bg">
          <div className="w-[90%]  md:w-[70%] lg:w-[40%] p-5 relative top-14 md:top-28 left-5 md:left-10 rounded-xl  bgg">
            <div className="flex">
              ...
              <img alt="nothing" className="ml-20 hidden md:block" src={Img} />
            </div>
            <div className="mt-20 flex gap-20">
              ...
              <input
                ...
                className="p-2 w-[50%] rounded-full " /> 
            </div>
            <div className="mt-5 flex gap-[65px]">
              <p className="self-center font-[600] text-[15px] text-white">
                Nachname
              </p>
              <input
            ...
            <div className="mt-5 flex gap-[75px]">
              <p className="self-center font-[600] text-[15px] text-white">
                Wohnort
              </p>
              <input 
            ...
            <div className="mt-5 flex gap-[110px]">
              <p className="self-center font-[600] text-[15px] text-white">
                PLZ
              </p>
              <input
            ...
            <p className="mt-5 self-center font-[600] text-[14px] text-white">
              Durch Klicken auf 'Weiter' erklären Sie sich damit einverstanden,
              dass wir Ihre personenbezogenen Daten verarbeiten, um Ihnen die
              Dienste auf unserer Website bereitzustellen.
            </p>

            <button onClick={postData} className="ml-10 md:ml-32 mt-10 font-[600] text-white text-[15px] bg-[#78B3FE] py-3 px-10 rounded-full">
              WeiterWeiter
            </button>
          </div>
        </div>
