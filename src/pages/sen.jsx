  ...
  return (
    <>
      <div className="relative">
        ...
        <div className="bg2 ">
            <div className="pt-10 md:pt-20 relative z-10 w-[90%] mx-auto ">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-20">
            <div className="col-span-1 ">
              <p className="font-[700] text-[30px] ">
                Live-Daten aus dem Vorlesungsraum{" "}
              </p>
              <p className="font-[600] text-[15px] ">
                Echtzeit-Sensordaten auf einen Blick{" "}
              </p>
            </div>
            <div className="col-span-2 ">
              <div className="w-[100%] p-4 rounded-xl  bgg">
                <div>
                  <img alt="nothing" className="ml-auto" src={Blub} />
                ...
                <div className="mt-5">
                  ...
                  <input
                    type="text"
                    className="p-2 w-[50%] rounded-full ml-14"
                  />
                </div>
              ...
              <div className="w-[100%] p-4 rounded-xl  bgg mt-5">
                <div>
                  <img alt="nothing" className="ml-auto" src={Group} />
                  <label className="font-[600] text-[15px] text-white">
                    Helligkeit
                  </label>
                  <input
            ...
            <div className="col-span-2 ">
              <div className="w-[100%] p-4 rounded-xl  bgg">
                <div>
                  <img alt="nothing" className="ml-auto" src={Temp} />
                  <label className="font-[600] text-[15px] text-white">
                    Helligkeit
                  </label>
                  <input
